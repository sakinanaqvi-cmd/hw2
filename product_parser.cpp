...
{
    Book * book = new Book(isbn_, author_, categoryID(), prodName_, price_, qty_);
    return book;
}
...
{
    Clothing * clothing = new Clothing(size_, brand_, categoryID(), prodName_, price_, qty_);
    return clothing;
}
...
{
    Movie * movie = new Movie(genre_, rating_, categoryID(), prodName_, price_, qty_);
    return movie;
